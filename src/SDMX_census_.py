...
def create_gpkg_gml(shp,df):
    ...
    outputxsd_filename = './OUTPUT/' + gpck_cntr + '_ESTAT_DF_CENSUS_GRID_2021_' + datetime.today().strftime('%Y%m%d%H%M%S') + '.xsd'
    zipped_filenames.append(outputGeopackage_filename) #zip this file
    zipped_filenames.append(outputGml_filename)
...
def createMetadataCountries(df):
    ...
    resourceLocator_value = base_url
