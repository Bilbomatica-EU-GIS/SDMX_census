...
for opt, arg in opts:
    if opt in ('-h', '--help'):
        ...
        print('    z, optional, default-value:\'[country code]_[atom-name]_3035[_GML]\', --zip-name=name-second-part')      
        ...
        print('    set zip file name to a different suffix (to replace \"_3035\" part from \"[country code]_[atom-name]_3035[_GML]\")') 
